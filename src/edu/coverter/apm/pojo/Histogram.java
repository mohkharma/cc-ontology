...
public class Histogram {
    ...
    public Histogram with1s(Long _1s) {
        this._1s = _1s;
        return this;
    }
    ...
    public Histogram with3s(Long _3s) {
        this._3s = _3s;
        return this;
    }
    ...
    public Histogram with5s(Long _5s) {
        this._5s = _5s;
        return this;
    }
    ...
    public Histogram withSlow(Long slow) {
        this.slow = slow;
        return this;
    }
    ...
    public Histogram withError(Long error) {
        this.error = error;
        return this;
    }
    ...
    public Histogram withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
