...
public class ResponseStatistics {
    ...
    public ResponseStatistics withTot(Long tot) {
        this.tot = tot;
        return this;
    }
    ...
    public ResponseStatistics withSum(Long sum) {
        this.sum = sum;
        return this;
    }
    ...
    public ResponseStatistics withAvg(Long avg) {
        this.avg = avg;
        return this;
    }
    ...
    public ResponseStatistics withMax(Long max) {
        this.max = max;
        return this;
    }
    ...
    public ResponseStatistics withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ResponseStatistics.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tot");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ResponseStatistics) == false) {
            return false;
        }
        ResponseStatistics rhs = ((ResponseStatistics) other);
